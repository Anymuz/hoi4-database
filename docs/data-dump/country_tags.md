...
Source: `common/country_tags/00_countries.txt`
...
| WGR | countries/West Germany.txt |
| DDR | countries/East Germany.txt |
...
| CRC | countries/Curacao.txt |
| GDL | countries/Guadeloupe.txt |
| GYA | countries/Guyana.txt |
...
| RAP | countries/Rapa Nui.txt |
| YUC | countries/Yucatan.txt |
| RIG | countries/Rio Grande.txt |
| QUE | countries/Quebec.txt |
| KAT | countries/Katanga.txt |
| BIA | countries/Biafra.txt |
| WLA | countries/Welsh Argentina.txt |
| CBV | countries/Cabo Verde.txt |
| BAR | countries/Barotseland.txt |
| EVE | countries/Evenkia.txt |
| SOK | countries/Sokoto.txt |
| THU | countries/Thuringia.txt |
| HES | countries/Hesse.txt |
| RHI | countries/Rhineland.txt |
| UBD | countries/United Baltic Duchy.txt |
| KOS | countries/Kosovo.txt |
| RKB | countries/Reichskommisariat Belgien.txt |
| RKN | countries/Reichskommisariat Niederlande.txt |
| RKG | countries/Reichskommisariat Norwegen.txt |
| RKU | countries/Reichskommisariat Ukraine.txt |
| RKO | countries/Reichskommisariat Ostland.txt |
| RKK | countries/Reichskommisariat Kaukasien.txt |
| RKT | countries/Reichskommisariat Turkestan.txt |
| RKM | countries/Reichskommisariat Moskowien.txt |
| RKL | countries/Reichskommisariat Urals.txt |
| GEN | countries/Generalgouvernement.txt |
| RKH | countries/Bohmen Mahren.txt |
| RKI | countries/Reichskommisariat Iberien.txt |
| RKC | countries/Reichskommisariat Balkan.txt |
| RGB | countries/Reichskommisariat Grossbritannien.txt |
| RKA | countries/Reichskommisariat Mittelafrika.txt |
| RNA | countries/Reichskommisariat Nordafrika.txt |
| RKV | countries/Reichskommisariat Klein Venedig.txt |
| RAN | countries/Reichskommisariat Anden.txt |
| RCO | countries/Reichskommisariat Kolumbus.txt |
| RUS | countries/Reichskommisariat Nordamerika.txt |
| RHD | countries/Reichskommisariat Grosshindustan.txt |
| RAR | countries/Reichskommisariat Arabien.txt |
| ROA | countries/Reichskommisariat Ostasien.txt |
| RAA | countries/Reichskommisariat Australasien.txt |
| GAR | countries/Guarani.txt |
| INC | countries/Inca.txt |
| MIS | countries/Miskito.txt |
| MAY | countries/Maya.txt |
| INU | countries/Inuit.txt |
| CHR | countries/Charrua.txt |
| ITZ | countries/Itza.txt |
| NAH | countries/Nahua.txt |
| IAS | countries/Isthmo Amerindia.txt |
| DIP | countries/Partisans.txt |
...
| FSA | countries/Federation of South Arabia.txt |
| ASY | countries/Assyria.txt |
| BHR | countries/Bahrain.txt |
| IMO | countries/Omani Imamate.txt |
| BLC | countries/Balochistan.txt |
| EZO | countries/Ezo Republic.txt |
| OKN | countries/Okinawa.txt |
| ANU | countries/Ainu.txt |
| PLU | countries/Palau.txt |
| FOR | countries/Formosa.txt |
| TML | countries/Timor Leste.txt |
| CHM | countries/Champa.txt |
| SNG | countries/Singapore.txt |
| SAR | countries/Sarawak.txt |
| SAB | countries/Sabah.txt |
| BRN | countries/Brunei.txt |
| WPG | countries/West Papua.txt |
| KUM | countries/Kumul Khanate.txt |
| GSM | countries/Gansu Ma.txt |
| GDC | countries/Guangdong.txt |
| KHM | countries/Khotan Ma.txt |
| NXM | countries/Ningxia Ma.txt |
| SND | countries/Shandong.txt |
| SIC | countries/Sichuan.txt |
| XIC | countries/Xian.txt |
| RNG | countries/Reorganized National Government.txt |
| PSR | countries/Philippine Second Republic.txt |
| HBC | countries/Hebei-Chahar.txt |
