...
\copy faction_rule_groups(rule_group_key, source_file) FROM 'data/csv/faction_rule_groups.csv' WITH (FORMAT csv, HEADER);
\copy faction_manifests(manifest_key, name_loc, description_loc, is_manifest, total_amount, dlc_source, source_file) FROM 'data/csv/faction_manifests.csv' WITH (FORMAT csv, HEADER);
\copy faction_goals(goal_key, name_loc, description_loc, category, goal_group, dlc_source, source_file) FROM 'data/csv/faction_goals.csv' WITH (FORMAT csv, HEADER);
\copy faction_member_upgrade_groups(group_key, name_loc, description_loc, default_upgrade_key, upgrade_type, icon, dlc_source, source_file) FROM 'data/csv/faction_member_upgrade_groups.csv' WITH (FORMAT csv, HEADER);
\copy special_project_specializations(specialization_key, source_file) FROM 'data/csv/special_project_specializations.csv' WITH (FORMAT csv, HEADER);
\copy special_project_tags(tag_key) FROM 'data/csv/special_project_tags.csv' WITH (FORMAT csv, HEADER);
\copy collections(collection_key, name_loc, input_source, dlc_source, source_file) FROM 'data/csv/collections.csv' WITH (FORMAT csv, HEADER);
\copy ai_faction_theaters(theater_key, name_loc, dlc_source, source_file) FROM 'data/csv/ai_faction_theaters.csv' WITH (FORMAT csv, HEADER);
\copy timed_activities(activity_key, dlc_source, source_file) FROM 'data/csv/timed_activities.csv' WITH (FORMAT csv, HEADER);
...
\copy faction_rules(rule_key, rule_type, dlc_source, source_file) FROM 'data/csv/faction_rules.csv' WITH (FORMAT csv, HEADER);
\copy faction_templates(template_key, name_loc, manifest_key, icon, can_leader_join_other, dlc_source, source_file) FROM 'data/csv/faction_templates.csv' WITH (FORMAT csv, HEADER);
\copy faction_member_upgrades(upgrade_key, group_key, bonus, description_loc, dlc_source, source_file) FROM 'data/csv/faction_member_upgrades.csv' WITH (FORMAT csv, HEADER);
\copy special_projects(project_key, specialization_key, project_tag, complexity, prototype_time, dlc_source, source_file) FROM 'data/csv/special_projects.csv' WITH (FORMAT csv, HEADER);
\copy special_project_rewards(reward_key, specialization_key, fire_only_once, threshold_min, threshold_max, dlc_source, source_file) FROM 'data/csv/special_project_rewards.csv' WITH (FORMAT csv, HEADER);
\copy timed_activity_equipment(activity_key, equipment_key, amount) FROM 'data/csv/timed_activity_equipment.csv' WITH (FORMAT csv, HEADER);
...
\copy faction_rule_group_members(rule_group_key, rule_key) FROM 'data/csv/faction_rule_group_members.csv' WITH (FORMAT csv, HEADER);
\copy faction_template_goals(template_key, goal_key) FROM 'data/csv/faction_template_goals.csv' WITH (FORMAT csv, HEADER);
\copy faction_template_rules(template_key, rule_key) FROM 'data/csv/faction_template_rules.csv' WITH (FORMAT csv, HEADER);
\copy special_project_reward_links(project_key, reward_key) FROM 'data/csv/special_project_reward_links.csv' WITH (FORMAT csv, HEADER);
...
\copy ai_faction_theater_regions(theater_key, region_id) FROM 'data/csv/ai_faction_theater_regions.csv' WITH (FORMAT csv, HEADER);
...
\copy _stage_chars FROM 'data/csv/characters.csv' WITH (FORMAT csv, HEADER)
...
\copy _stage_cr FROM 'data/csv/character_roles.csv' WITH (FORMAT csv, HEADER)
...
\copy _stage_evm FROM 'data/csv/equipment_variant_modules.csv' WITH (FORMAT csv, HEADER);
...
\copy _stage_evu FROM 'data/csv/equipment_variant_upgrades.csv' WITH (FORMAT csv, HEADER);
