...
\copy state_buildings(state_id, building_key, level, source_file) FROM 'data/csv/state_buildings.csv' WITH (FORMAT csv, HEADER);
...
\copy country_starting_technologies(country_tag, technology_key, source_file) FROM 'data/csv/country_starting_technologies.csv' WITH (FORMAT csv, HEADER);
...
\copy equipment_variants(owner_tag, base_equipment_key, version_name, source_file) FROM 'data/csv/equipment_variants.csv' WITH (FORMAT csv, HEADER);
